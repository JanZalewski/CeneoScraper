...
Średnia ocena produktu została wyznaczona na podstawie liczby gwiazdek w opiniach wynosi {averageScore:.1f}.''')

stars = opinions.stars.value_counts().reindex(np.arange(0,5.5,0.5))
